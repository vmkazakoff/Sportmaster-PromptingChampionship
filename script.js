...
function updateLeaderboard(teams) {
    ...
    elements.leaderboard.innerHTML = sortedTeams.map((team, index) => `
        <div class="flex items-center justify-between py-3 px-4 hover:bg-gray-50 transition-colors duration-200">
            <div class="flex items-center">
                <div class="text-2xl font-bold text-gpb-orange mr-6 w-8">${index + 1}</div>
                <div>
                    <div class="font-bold text-black text-lg">${team.teamName}</div>
                    <div class="text-sm text-gpb-text-light">
